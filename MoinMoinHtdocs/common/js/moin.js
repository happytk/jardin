...
// default wiki-root
// set_script_root 함수를 통해 제어한다.
var MOIN_SCRIPT_ROOT = "/wiki";


$(document).ready(function() {

    $('#interwikimap').change(function() {
        $("#interwikimap option:selected").each(function() {
...
function wiki_edit() {
    if (typeof gui_editor_link_href !="undefined") {
        ...
        wiki_action(getPageName(), "garden");
    }
}
...
document.onkeypress = function (e) {
    ...
    hotkey['l'] = "javascript:wiki_action(getPageName(), 'LikePages');";
    hotkey['ㅣ'] = "javascript:wiki_action(getPageName(), 'LikePages');";
    // hotkey['q'] = "javascript:convert_editor(null);";
    // hotkey['ㅂ'] = "javascript:convert_editor(null);";
...
function getAuthor(authorId) {
    var authorObj = document.getElementById(authorId);
    var author = getCookie('wecanfly_guestbook_author');
    if (author != '') {
