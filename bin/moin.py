...
if __name__ == "__main__":
    ...
    wiki_dir = os.environ['WIKI']
    sys.path.insert(1, os.environ['MOIN'])
    sys.path.insert(1, os.path.join(os.path.abspath(os.environ['MOIN']), 'support'))
    sys.path.insert(1, wiki_dir)
