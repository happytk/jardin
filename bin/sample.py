...
if os.path.isdir(MOINPATH) and \
   os.path.isdir(os.path.join(MOINPATH, 'support')) and \
   os.path.isdir(os.path.join(MOINPATH, 'MoinMoin', 'support')):
    pass
else:
    print 'check moin directory'
    sys.exit(1)
...
if __name__ == "__main__":
    run_server(hostname='', port=8099, docs=os.path.join(MOINPATH, 'MoinMoinHtdocs'))
