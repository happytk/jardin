...
options_no_group_name = {
  # =========================================================================
  'zeze_moin_customized_sqlrun': ('zeze_moin_customized_sqlrun', None,
  (
    ('sqlrun_storage', 'mongodb', ''),
    ('sqlrun_mongodb_host', 'localhost', ''),
    ('sqlrun_mongodb_port', 27017, ''),
    ('sqlrun_mongodb_lockdb', 'sqlrun', ''),
    ('sqlrun_mongodb_lock_coll', 'sqlrun_lock', ''),
    ('sqlrun_dbconns', {}, ''),
    ('sqlrun_oracle_home', None, ''),
  )),
  # =========================================================================
  ...
  (
    ...
    ('fs_extension', '.md', ''),
    ('middlewares', {'wiki': (MoinWikiMiddleware, ()),}, 'Middlewares using this system'),
    ('routes', {re.compile(r'.*'): 'wiki'}, 'Pagename router infomation'),
    ('pagename_router', lambda cfg, x: x, ''),
    ('user_wiki_rule_formatter', lambda cfg, fmt, word: word, ''),
    ('user_wiki_rule', '', ''),
  ...
  (
    ...
    ('webfont_default', '', ""),
    ('mac_webfont_default', 'x', ''),
    ('mobile_webfont_default', 'x', ""),
    ('theme_force', False,
    ...
    ('edit_bar', ['Garden', 'Comments', 'Discussion', 'Info', 'Subscribe', 'Quicklink', 'Attachments', 'ActionsMenu'],
  ...
  'user': ('User Preferences related', None, (
    ...
    ('usercss_default', '',
     'user-customized css'),
    ('mac_usercss_default', '',
     'user-customized css for mac'),
    ('mobile_usercss_default', '',
     'user-customized css for mobile'),
    ...
    'user': ('Users / User settings', None, (
      ...
      ('checkbox_fields',
       [
        ...
        # ('webfont_preferred', lambda _: _('is webfont preferred')),
        ('mobile_preferred', lambda _: _('is mobile preferred')),
        ('use_attachf', lambda _: _('Use enhanced attachment action')),
        ('include_dayone_to_all', lambda _: _('Include dayone to all pages')),
        ('include_dayone_backlinks', lambda _: _('Include dayone references')),
      ...
      ('checkbox_defaults',
       {
        ...
        'mobile_preferred': 0,
        'use_attachf': 0,
        'include_dayone_to_all': 0,
        'include_dayone_backlinks': 0,
       },
      ...
      ('form_fields',
       [
        ...
        ('line_height', _('Body line height'), "text", "6", ''),
        ('mobile_font_size', _('Mobile font Size(px)'), "text", "6", ''),
       ],
       None),
