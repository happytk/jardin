...
class User:
    ...
    def __init__(self, request, id=None, name="", password=None, auth_username="", **kw):
        ...
        self.usercss = self._cfg.usercss_default
        self.mac_usercss = self._cfg.mac_usercss_default
        self.mobile_usercss = self._cfg.mobile_usercss_default
        ...
        self.webfont_name = self._cfg.webfont_default
        self.mac_webfont_name = self._cfg.mac_webfont_default
        self.mobile_webfont_name = self._cfg.mobile_webfont_default
